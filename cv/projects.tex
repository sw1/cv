...
\cventry
    ...
    {}
    {
     ...
     \item{\href{https://}{Mitchell, D. V., \textbf{\underline{Woloszynek, S.}}, Mitchel, M. W., Cronin, D., Zhao, Z., Rosen, G. L., O'Connor, M. P., Fero, M. and Gonder, M. K. Growth and globalization of the Central African wildlife economy: Insights from a 23-year study of wild meat markets on Bioko Island, Equatorial Guinea. 2024. \textit{Submitted for review}.}}
...
\cventry
    ...
    {}
    {
     \begin{cvitems} % Description(s)
          \vspace{-.8cm}
     \descriptionstyle{
         \item{*Meier, T. A., Rafahi, M. S., Hearne, G., Restifo, D. S., Munoz-Acuna, R., Rosen, G. L., and **\textbf{\underline{Woloszynek, S.}}. The Role and Applications of Artificial Intelligence in the Treatment of Chronic Pain. 2024. \textit{Accepted for publication.} *\textit{authorship randomized.} **\textit{supervising author.}} 
