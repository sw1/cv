...
\cventry
    ...
    {}
    {
     \begin{cvitems} % Description(s)
          \vspace{-.8cm}
     \descriptionstyle{
        \item{\href{https://cran.r-project.org/package=themetagenomics}{Themetagenomics. \textbf{\underline{Woloszynek, S.}}, R package version 1.0.1.}, \href{https://github.com/sw1/themetagenomics}{github.com/sw1/themetagenomics}}
