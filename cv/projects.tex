...
\cventry
    ...
    {}
    {
     ...
     \vspace{-.8cm}
     \descriptionstyle{
      \item{Zhao, Z., \textbf{\underline{Woloszynek, S.}}, Agbavor, F., Mell, J. C., Sokhansanj, B. A., and Rosen, G. L. Learning, Visualizing and Exploring 16S rRNA Structure Using an Attention-Based Deep Neural Network. In Review.}
